...
- [구현 목표 및 개요](#구현-목표-및-개요)
  - [1. 프로젝트 개요](#1-프로젝트-개요)
  - [2. 개발 환경 및 스펙 (MCU, IDE, 도구)](#2-개발-환경-및-스펙-mcu-ide-도구)
- [요구 사항 정의](#요구-사항-정의)
  - [1. 기능 요구사항](#1-기능-요구사항)
  - [2. 비기능 요구사항 / 제약사항](#2-비기능-요구사항--제약사항)
- [시스템 아키텍처](#시스템-아키텍처)
...
- UART 통신으로 `R/r` 명령을 입력하면 모터는 역방향(`CCW`)으로 동작해야한다
- UART통신 입력창에 `0~9`까지 숫자를 입력하면 모터의 속도를 변경 할 수 있다 
